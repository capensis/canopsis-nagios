...
register_callbacks ()
{
  ...
  neb_register_callback (NEBCALLBACK_PROGRAM_STATUS_DATA, g_nagios_handle, 0,
  ...
  neb_register_callback (NEBCALLBACK_ACKNOWLEDGEMENT_DATA, g_nagios_handle, 0,
...
deregister_callbacks ()
{
  ...
  neb_deregister_callback (NEBCALLBACK_PROGRAM_STATUS_DATA,
			   event_program_status);
  ...
  neb_deregister_callback (NEBCALLBACK_ACKNOWLEDGEMENT_DATA,
			   event_acknowledgement);
