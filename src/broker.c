...
void n2a_register_callbacks (void)
{
    n2a_logger (LG_INFO, "Register callbacks");
/*
    neb_register_callback (NEBCALLBACK_PROCESS_DATA,         g_options.nagios_handle, 0, n2a_event_process);
    neb_register_callback (NEBCALLBACK_PROGRAM_STATUS_DATA,  g_options.nagios_handle, 0, n2a_event_program_status);
*/
...
/*
    neb_deregister_callback (NEBCALLBACK_PROCESS_DATA,         n2a_event_process);
    neb_deregister_callback (NEBCALLBACK_PROGRAM_STATUS_DATA,  n2a_event_program_status);
*/
