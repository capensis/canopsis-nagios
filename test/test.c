...
==9087== 
==9087== HEAP SUMMARY:
==9087==     in use at exit: 0 bytes in 0 blocks
==9087==   total heap usage: 77,948 allocs, 77,948 frees, 7,837,824 bytes allocated
==9087== 
==9087== All heap blocks were freed -- no leaks are possible
==9087== 
==9087== For counts of detected and suppressed errors, rerun with: -v
==9087== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 7 from 7)
*/
