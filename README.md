...
Options:
    ...
    hostgroups =        If 'true', send host groups on host-check events
    servicegroups =     If 'true', send service groups on service-check events
    acknowledgement =   If 'true', handle acknowledgement events
    downtime =          If 'true', handle downtime events
    custom_variables =  If 'true', add Nagios macros to event
